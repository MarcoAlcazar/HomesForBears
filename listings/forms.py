...
from listings.models import Landlord, Housing
...
class HousingForm(forms.ModelForm):
    class Meta:
        model = Housing
        fields = ('Address', 'Bedrooms', 'Bathrooms', 'Description', 'Rating', 'Price', 'LandLord',
                  'housing_image', 'housing_image2', 'housing_image3', 'housing_image4', 'housing_image5')
        labels = {
            'Address': '',
            'Bedrooms': '',
            'Bathrooms': '',
